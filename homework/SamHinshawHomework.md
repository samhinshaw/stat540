...
clean: 
	rm -rf SamHinshawHomework.md SamHinshawHomework.html data_fixed.txt
	sed -i '/data.txt.gz/d' ../.gitignore
	sed -i '/design.txt/d' ../.gitignore
	sed -i '/data.txt/d' ../.gitignore
	sed -i '/data_fixed.txt/d' ../.gitignore
...
data_fixed: data.txt
	...
	sed -i -e 's/^"GSE10718_Biomat_1"/"probeIDs"	"GSE10718_Biomat_1"/' data_fixed.txt
	
homework:  SamHinshawHomework.Rmd gitignore data_fixed
...
********
This page was last updated on  Tuesday, March 01, 2016 at 03:32PM
